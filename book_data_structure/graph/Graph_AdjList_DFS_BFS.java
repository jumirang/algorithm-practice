...
class LinkedStack {
  ...
  public int pop() {
    if (isEmpty()) {
      System.out.println("Deleting failed!! Linked Stack is empty!!");
      return 0;
    } else {
      int item = top.data;
      top = top.link;
...
class LinkedQueue {
  ...
  public int deQueue() {
    if (isEmpty()) {
      System.out.println("Deleting failed!! Linked Queue is empty!!");
      return 0;
    } else {
      int item = front.data;
      front = front.link;
...
public class Graph_AdjList_DFS_BFS {
